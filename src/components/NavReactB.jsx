        ...
        <Navbar bg="light" className="sticky-top">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto condensed">
                    ...
                    <Nav.Link to="/computadoras" as={NavLink}>Computadoras</Nav.Link>
                    <Nav.Link to="/notebooks" as={NavLink}>Notebooks</Nav.Link>
                    <Nav.Link to="/accesorios" as={NavLink}>Accesorios</Nav.Link>
                    <Nav.Link to="/nosotros" as={NavLink}>Sobre Nosotros</Nav.Link>
