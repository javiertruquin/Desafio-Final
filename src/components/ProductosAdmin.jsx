      ...
      <Container className="">
        <div className="row bg-fondo-producto-admin img-fluid">
          ...
          <div className="col-lg-6  py-5 mt-4 text-center">
            <div className=" mx-5"><button onClick={handleCrear} className="btn-dash py-2 px-4">
              <i className="fas fa-plus-square me-3"></i>Agregar producto
            </button></div>
        ...
        <div className="">
          ...
          <DropdownButton onSelect={handleSelect} id="dropdown-basic-button" title="Filtro">
            <Dropdown.Item eventKey="1">Todos los productos</Dropdown.Item>
            ...
            <Dropdown.Item eventKey="5">Productos Habilitados</Dropdown.Item>
            <Dropdown.Item eventKey="6">Productos Deshabilitados</Dropdown.Item>
